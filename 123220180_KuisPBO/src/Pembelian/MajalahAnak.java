...
class halamanAnak extends JFrame{
    JLabel headerAnak = new JLabel("Halaman Pembelian");
    JLabel tulisan1 = new JLabel("Kategori");
    JLabel tulisan2 = new JLabel("Majalah Anak");
    JLabel tulisan3 = new JLabel("Harga");
    JLabel tulisan4 = new JLabel("Rp. 12.700/pcs");
    ...
    halamanAnak(){
        ...
        setLayout(null);
        add(headerAnak);
        headerAnak.setBounds(25,5,150,35);
